...
public class SystemHelper {
	...
	/*
	 * @author Marcel G A Class with several operations which several classes need
	 * like logout, getting current user, etc.
	 */
	 ...
	 * 
	 */
	public static OperationPosition isComposedOperationsStarted(String nameOfOperation, String parameter, String rule,
			String context) {
	...
	// To write Messages
	public static void WriteSystemMessage(String receiver, String text, String atomicOperation,
			String concernedRuleTerm, String containingContext, String concernedParameter, String[] additionalData) {
	...
	private static OperationPosition GenerateOp(String role, String composedOperation, String atomicOperation,
			String rule, String context, String parameter) {
		return GenerateOp(role, composedOperation, atomicOperation, rule, context, parameter, new String[0]);
	}

	private static OperationPosition GenerateOp(String role, String composedOperation, String atomicOperation,
			String rule, String context, String parameter, String[] additionalData) {
		OperationPosition op = null;
		SystemUser user = SystemHelper.getSpecificUser(role);
		SystemHelper.WriteSystemMessage(user.getName(), composedOperation, atomicOperation, rule, context, parameter,
				additionalData);
	...
	public static OperationPosition ContextualizeRule(String rule, String context) {
		OperationPosition op = null;
		op = GenerateOp(SystemHelper.RULE_DEVELOPER, SystemHelper.COM_CONTEXTUALIZE_RULE, SystemHelper.CHANGECONTEXT,
				rule, context, "");
		return op;
	}
	...
	/*
	 * Rule wird nicht benötigt da in einem COntext mehrere Rules sein können Der
	 * RuleDev. muss nur benachrichtigt werden alle Regeln aus einem bestimmten
	 * Context zu löschen!
	 */
	...
	public static OperationPosition MergeContext(String rule, String context) {
		OperationPosition op = null;
		op = GenerateOp(SystemHelper.RULE_DEVELOPER, SystemHelper.COM_MERGE_CONTEXT, SystemHelper.CHANGECONTEXT, rule,
				context, "");
		return op;
	}
	...
	public static OperationPosition ModifyRule(String rule) {
		OperationPosition op = null;
		op = GenerateOp(SystemHelper.RULE_DEVELOPER, SystemHelper.COM_MODIFY_RULE, SystemHelper.DELETE_RULE, rule, "",
				"");
		return op;
	}
	...
	public static OperationPosition AddRule(String context, String rule) {
		OperationPosition op = null;
		op = GenerateOp(SystemHelper.RULE_DEVELOPER, SystemHelper.COM_NEW_RULE, SystemHelper.NEW_RULE, rule, context,
				"");
		return op;
	}
	...
	public static OperationPosition DeleteRule(String context, String rule) {
		OperationPosition op = null;
		op = GenerateOp(SystemHelper.RULE_DEVELOPER, SystemHelper.COM_DELETE_RULE, SystemHelper.DELETE_RULE, rule,
				context, "");
		return op;
	}
