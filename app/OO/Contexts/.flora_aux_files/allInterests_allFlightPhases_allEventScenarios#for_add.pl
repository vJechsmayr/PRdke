...
#mode save
#mode nocomment "%"
#define FLORA_THIS_FILENAME  'allInterests_allFlightPhases_allEventScenarios.flr'
#mode restore
...
#mode save
#mode nocomment "%"
#define FLORA_FDB_FILENAME  'allInterests_allFlightPhases_allEventScenarios#for_add.fdb'
#mode restore
...
#mode save
#mode nocomment "%"
#define FLORA_FLD_FILENAME  'allInterests_allFlightPhases_allEventScenarios#for_add.fld'
#mode restore
...
#mode save
#mode nocomment "%"
#define FLORA_FLS_FILENAME  'allInterests_allFlightPhases_allEventScenarios.fls'
#mode restore
...
#mode save
#mode nocomment "%"
#define FLORA_FLS2_FILENAME  'allInterests_allFlightPhases_allEventScenarios.fls2'
#mode restore
